<template>
    <div class="q-pa-md q-gutter-sm">
        ...
        <q-btn outline color="white" text-color="grey-10" icon="fa fa-play" @click="menuStore.menu_rendererAtivarParar(true, true)">
            <q-tooltip>
                Ativar layout (Barra de Espaço)
            </q-tooltip>
        </q-btn>
        <q-btn outline color="white" text-color="grey-10" icon="fa fa-stop" @click="menuStore.menu_rendererAtivarParar(false, true)">
            <q-tooltip>
        ...
        <q-btn outline color="white" text-color="grey-10" icon="fa fa-search-minus" @click="menuStore.menu_zoomout">
            <q-tooltip>
        ...
        <q-btn outline color="white" text-color="grey-10" icon="fa fa-layer-group" @click="menuStore.menu_incluir1Camada('')">
            <q-tooltip>
                Expande Vínculos Societários em Camada 1 (Tecla 1)
            </q-tooltip>
        </q-btn>
        <q-btn outline color="white" text-color="grey-10" @click="menuStore.menu_botao_caminhos('')">
        ...
        <q-btn outline color="white" text-color="grey-10" icon="fa fa-file-excel" @click="menuStore.menu_exportaExcel(false)">
            <q-tooltip>
                Salva arquivo Excel com dados dos itens da tela
            </q-tooltip>
        </q-btn>
        <q-btn outline color="white" text-color="grey-10" icon="fa fa-globe" @click="menuStore.menu_exportaArquivo(false, 'osm')">
            <q-tooltip>
